...
public class UserService {
    ...
    public String createInfoUser(Map<String, String> data) {
    ...
    public String updateInfoUser(Map<String, String> data) {
        Map<String, String> errors =
                new UserValidator().validateUserData(data);
        if (!errors.isEmpty()) {
            try {
    ...
    public String deleteInfoUser(Map<String, String> data) {
        Map<String, String> errors =
                new UserValidator().validateUserData(data);
        if (!errors.isEmpty()) {
            try {
